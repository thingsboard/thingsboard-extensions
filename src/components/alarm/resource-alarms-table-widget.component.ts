...
import { DataKey, WidgetActionDescriptor, WidgetConfig } from '@shared/public-api';
import { IWidgetSubscription } from '@core/public-api';
import { UtilsService } from '@core/public-api';
import { TranslateService } from '@ngx-translate/core';
import { deepClone, hashCode, isDefined, isDefinedAndNotNull, isNumber, isObject, isUndefined } from '@core/public-api';
import { sortItems } from '@shared/public-api';
...
import { AlarmDataInfo, alarmFields, AlarmInfo, alarmSeverityColors, AlarmStatus } from '@shared/public-api';
import { DatePipe } from '@angular/common';
import { MatDialog } from '@angular/material/dialog';
import { NULL_UUID } from '@shared/public-api';
import { DialogService } from '@core/public-api';
import { AlarmService } from '@core/public-api';
import {
  AlarmData,
  AlarmDataPageLink,
  dataKeyToEntityKey,
...
@Component({
  selector: 'tb-resource-alarms-table-widget',
  templateUrl: './resource-alarms-table-widget.component.html',
  styleUrls: ['./resource-alarms-table-widget.component.scss', '../table-widget.scss']
})
export class ResourseAlarmsTableWidgetComponent extends PageComponent implements OnInit, OnDestroy, AfterViewInit {
