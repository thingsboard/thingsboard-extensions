...
interface ExtendFlotSeries extends TbFlotSeries {
    lines?: any;
    points?: any;
    curvedLines?: any;
    color?: any;
...
interface ExtendFlotAxisOptions extends TbFlotAxisOptions {
    show?: any;
}
...
export class TbFlot {
    ...
    private init($element: JQuery<any>, subscription: IWidgetSubscription) {
        ...
        for (let i = 0; i < this.subscription.data.length; i++) {
            const series = this.subscription.data[i] as ExtendFlotSeries;
            ...
            if (this.yaxis) {
                ...
                let yaxis: ExtendFlotAxisOptions;
    ...
    public updateSeriesColor(color: string) {
        if (this.subscription?.data?.length) {
            const series = this.subscription.data[0] as ExtendFlotSeries;
